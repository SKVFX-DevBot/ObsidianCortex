...
- [ ] #27 Slash commands: custom ObsidiBot commands from vault files
...
- [x] #15 FrontmatterGuard context injection: obsidibot-context: always + obsidibot-instructions per-note frontmatter ✅ 2026-03-20
- [x] #16 Permanent pinning: obsidibot-context: always injects full note at every session start ✅ 2026-03-20
...
- [x] send-selection-to-obsidibot, focus-obsidibot-input, open-obsidibot-context-file, show-obsidibot-about commands ✅ 2026-03-20
...
- [x] #12 Add ObsidiBot Command: Open Settings ✅ 2026-03-17
- [x] #14 Ctrl+P command names out of date in USER_README.md ✅ 2026-03-17
- [x] #9  Replace "Ask Claude..." with "Ask ObsidiBot..." in input box ✅ 2026-03-12
