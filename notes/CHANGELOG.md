...
## [2.0.0](https://github.com/SKVFX-DevBot/ObsidianCortex/compare/v1.5.4...v2.0.0) (2026-04-09)
...
* [#21](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/21) Vault context file auto-generation on first launch ([7329009](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/7329009f76998e218b7f95cac516bc5c987246ad))
* [#40](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/40) using @ to inject full notes as context ([75f8cf0](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/75f8cf025ec9806913520e3c0b1a9777f70288c2))
* [#7](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/7)  Improve "thinking" feedback (better spinner/status while waiting) ([b15790f](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b15790fbe824f313d5236d9cc5c7bf93abc81f6a))
* [#8](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/8)  Up/down arrow to scroll through previous input messages ([92d198b](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/92d198b4c6c2343927785043e69fce7525483ad4))
* add Focus input, Open context file, and About commands ([3dcd5c1](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/3dcd5c1f36d8a6bee909b30e6aa8edc249038b56))
* added an interrupt/stop button for interrupting long or unwanted tasks. ([3df5318](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/3df5318f6cdbfeb840832a66d03c0bc705ac7107))
* added vault tree (context) depth settings ([5248300](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/5248300b9aa0bb1ca319dd0ef92edfebd48ae9cb))
* Attachment button: open up the paperclip to add files, URLs, and other content to the context stack ([d644f89](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/d644f892381c6b8c2956df3f2a5bcd1db22b7b05))
* BRAT/publication compatible build ([ba0229a](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/ba0229a1a6389989bf49a4381204b98dbd1d1041))
* current note is pre-selected in @ mention context injection & additional file types (pdf, fountain - configurable) are now supported ([a107623](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/a10762312bda06474977309e1e9a832f8ad1832f))
* drag-and-drop session manager sorting ([61afdf2](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/61afdf2e5de0e8753cee7b78238b981e64d8aed4))
* frontmatter context injection and active note awareness ([#15](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/15)) ([c12aeea](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/c12aeea19d392eb40a64651883b559f7bd963e77))
* gracefully handle and walk the user through setting up a broken claude CLI setup ([c507df8](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/c507df806d4f18e1c999ab949e3b27a4c1cca880))
* image and PDF support — attach via file picker, paste, or drag-and-drop ([1efcb5c](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/1efcb5ca1bb00a2c89e0cdd1d214f41a4579f87b))
* image/PDF attachments, drag-and-drop, export session to vault, transcript format ([48feb43](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/48feb4378575f853d09c0621b49a2fb0a880ebbf))
* logginpg settings, verbosity settings, start/stop, file location, etc. ([169084e](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/169084e59f88b8ebe321e2c91f3c9b91a57b2d42))
* Markdown rendering of responses in the panel ([5856475](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/5856475a3b620237b91242737b42181681978f69))
* multiple notes support ([98e8e10](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/98e8e104132af1daaba5976f88dfe43f44388634))
* native permission modes, replace --dangerously-skip-permissions ([#18](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/18)) ([3c41827](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/3c4182799d683a1025ab74e72a0e0db0efde82ab))
* new command: "Cortex: Refresh Session" ([b45e2a9](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b45e2a9b615e696060f7deea3cff06930c76fa54))
* plugin bootstrapped - beginning testing/debugging of basic systems ([5c4d024](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/5c4d024cc87cef6cf792f087e348f51d72db36ca))
* replace dangerously-skip-permissions with native permission modes ([#18](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/18)) ([1e986d8](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/1e986d824b1bcbf3edff7d43134dc9581940ea5b))
* run-command discovery, UI polish, and bug fixes ([b6821dd](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b6821ddbea5dda91615ce4e61f70bfc174e91020))
* send-on-enter option added to settings and functionality.  Plus, lots of visual cleanup - looking sexy ([b9acdf8](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b9acdf831532eb676dbdabcf94cb36d19d6f52b5))
* session context gas gauge added - warns about auto compaction ([6efa27b](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/6efa27b87c5fbc5268cae310692ad8b17688c2e0))
* session history UI, command palette, UI polish, and token logging ([c37d65a](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/c37d65ac79e02d4347fb2a737e12d4d2d36d9a11))
* session manager now shows which session is active ([06cce74](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/06cce747e71acb71aeadbaf7efe81e3e0620f031))
* Session-scoped pins: add a 📌 pin button next to the × on pending context items so pinned items survive send and stay in the stack for every subsequent message (see [#16](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/16)) ([83503c4](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/83503c4afd78b4e0224813ff71fe47b896ce8c8e))
* session, context, and memory management ([16d288b](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/16d288bc1b0dbcb8d47d243fe93bb07768d16f9c))
* show per-turn token usage stats below each response ([#43](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/43)) ([d478504](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/d4785040b6f6091c55c6c6a4fd62f2e975654a87))
* split-pane and side-by-side note editing support - configurable ([a280e42](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/a280e42f9b118f515f82bcd1cd33811f016a93c1))
* support built-in, configurable context: _claude-context.md ([66f777a](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/66f777ac7df88cb4d0bb34b3f1f478fb7af3ee31))
* tool call visibility, selection context injection, session replay fix ([#38](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/38), [#39](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/39), [#17](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/17)) ([61d91ef](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/61d91ef629d8e0f57ce4ac11bfe0723966a5099a))
* UI Bridge run-command action with settings command browser ([#47](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/47)) ([2121ddc](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/2121ddc2939bc2c7c354a62fb847d8bea6cc15c6))
* UI Bridge: allow Claude to trigger Obsidian UI actions [#32](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/32) - automatically open notes, focus on a section, etc. ([e16af56](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/e16af56b0242fee5247efcae02a3a6755e8f6c15))
* UI updates - new icons, access to online help, discord, settings, etc, from the chat panel ([6b988fb](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/6b988fb0b37fdd6bd9d847e89eef3ab045db9c53))
* vault query protocol — Claude can query live vault state ([#58](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/58)) ([98dad7e](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/98dad7eb08c4c41f39c426a1de27f5d7c3eb2c65))
* when using the @ mention context injection, pre-select the current note ([4b4775a](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/4b4775a6c2e4ffee764101c1cf9d7fa3635d6015))


### Bug Fixes

* add layer 0 context to give the agent some "you are here" context ([0bb37af](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/0bb37afb9dd96487174aab163ad5ef2521363607))
* added session persistence - claude will remember your name now ([dd76ab9](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/dd76ab96e533b12c9331fbbfc753e8c2b17f459b))
* adding the code workspace to the project ([78f9d16](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/78f9d16acfa4e3dbd4e1430ef00435c831c560c5))
* better, but not great, handling of logged-out users ([19102b9](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/19102b91a14869d6d3fc87a11ab3ed5ecf62f536))
* bug [#57](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/57): code blocks in assistant messages render as copy icon only ([b7d8069](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b7d80691a02d9b32b1384f7319272b1f9dd5f0ec))
* bug [#63](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/63):  restore last active session on startup instead of top-of-stack ([7e8e53c](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/7e8e53ccd0d51aee7ba1abf7d552fc5113f4727d))
* bug[#4](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/4) add unicode curly quotes support (smart-quoted text) ([c27e89d](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/c27e89dd956a26012553f952abcdf48519de2a0a))
* bug[#6](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/6) Include markdown in command-copied data from the chat-panel (plus a file size refactor) ([c3af74b](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/c3af74b25acf89d4dc41fdc359170ec74496825e))
* claude initialization ([7759e80](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/7759e8090705f88c00f2cc5a1b6853557ae2d543))
* cleanup verbose logging ([4c691ba](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/4c691ba8969713c907bd418bef32085aa4ed9a39))
* copy/paste of screenshots wasn't using unique names, so multiple screenshots were overwriting each other ([5b825b6](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/5b825b65dc58c5fdf7e320b2b3ca15da7d449518))
* copy/paste working ([8cdd637](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/8cdd637bcf489c6ffba98040fd4691dd5d865a07))
* correct release asset upload and project date-closed workflow ([e6728a3](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/e6728a39d7d5520cffec4daf916270d1e5310390))
* correct release asset upload and project token for workflows ([7cca123](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/7cca1233bd06e4c68dfd6cb1afe94c89d9b935f6))
* correct stale log path comment in LoggerConfig ([22fc52b](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/22fc52bc503c47d5ef073d1212dbf2ecd8e9330b))
* correct stale log path comment in LoggerConfig ([d19b6db](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/d19b6db040a96ef0f2de1753cb51d08473bf16ec))
* expanding the name change search - it was pretty easy to miss it before. ([2620880](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/262088024ddb2df376bf435c4d278aac4e0aab1f))
* first working version - read/write files in the vault ([b635aa9](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b635aa9ee707a5cde8614c92ea42bbc33d2699f9))
* fixes to tool use messages and selected text context injection ([54a2384](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/54a2384bb4e90fd749dc80d646f2027cb97904e4))
* move session history out of the plugin folder to fix symlink dev conflicts ([bcc42f2](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/bcc42f2f062ea4c844b114a4382b246b41c1f873))
* multiline input text now displays correctly in the chat panel ([2f0b5ad](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/2f0b5adc280ad6466b3022145b456d7ff8550917))
* refreshSessionContext now re-injects full orientation ([#69](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/69)) ([ce70f88](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/ce70f88858b9ed633cfc307ad529cdd50b914a19))
* refreshSessionContext re-injects full orientation ([#69](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/69)) ([18ea92f](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/18ea92f6505183976ccc71b41ded32b7c21dfec6))
* regression fix for cortex giving up on being inventive when needed. ([b126eef](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b126eef54cfcac757cba51050c2bb1c6e550008d))
* release-please automation: bump  manifest.json's version number. ([6ef40d6](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/6ef40d68c9910d62512050bb7208f303f65168fc))
* release-please version updating support for package.json ([c42fb94](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/c42fb944ef6be9369aa5f5f2198bc7e361936b60))
* remove obsidian data files from the repo - oops ([32020e9](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/32020e96cf48784feac119ad31d599da2289e6b7))
* renaming a session in the session manager changes the name in the chat panel immediately now ([1740193](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/1740193113daf65b3f5f2d6a3f271ebcffb5b986))
* replace the phrase, "Ask Claude..." with "Ask Cortex..." ([0000322](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/00003225043d7f1b17cd7b3f18231acd454ebbfb))
* sendOnEnter defaults to true now. Added a css box around the user message in the chat panel. ([ed2eb6b](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/ed2eb6be9bfff52ad4ba20f899c022299c158224))
* session duplication after Obsidian restart ([6c2b889](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/6c2b8890326c811c8f4a347afc06f6ed78c96403))
* session focus/renaming issues ([b40c069](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b40c069c097c22102c8ab1246265a53c32eabcb4))
* strip @@CORTEX_ACTION lines when replaying session history ([8043700](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/8043700352082d53c919eae06b754e7e50b41930))
* strip @@CORTEX_ACTION lines when replaying session history ([aaef64c](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/aaef64cc77b2c99361ec2d91f206860c8e9c5753)), closes [#83](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/83)
* test checkin - ignore ([b199bef](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/b199bef8f1757560d85d3f6bbd2ada60813df480))
* text parsing of doublequotes - included unit test ([96c5b52](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/96c5b52240152fcb93489584c6406092297cc87d))
* **ui:** add visual separation between sequential tool call events ([73ff0ab](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/73ff0abd91565b92b93eed8553d33d0d31705471))
* **ui:** add visual separation between sequential tool call events ([0bd9be6](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/0bd9be6933f7841f04899ed6e7a0cc51bdc67fba)), closes [#68](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/68)
* **ui:** ArrowDown no longer blocks cursor movement in recalled multiline messages ([433d633](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/433d633aed28fbfa212b2ce69ded7c1a47d3cec6))
* **ui:** prevent ArrowDown from blocking cursor movement in recalled multiline messages ([8775c9e](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/8775c9e55e30f6cebc75c08414501edc0249f554)), closes [#82](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/82)
* **ui:** restore status indicator during tool calls after text has streamed ([0c97521](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/0c975219985fe383c9fc5c8148496ff1d3e9e61d)), closes [#67](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/67)
* **ui:** suppress misleading "Interrupted." on clean UI-bridge-only turns ([9180ef0](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/9180ef027870faf11f4f0599b006b89f2fcf78cd))
* **ui:** suppress misleading Interrupted message on clean UI-bridge-only turns ([3ba0e68](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/3ba0e68ec94dbd44303429afde448d44092397b3)), closes [#76](https://github.com/SKVFX-DevBot/ObsidianCortex/issues/76)
* update icon in the right sidebar - TODO: move this to a variable. ([6c84dfb](https://github.com/SKVFX-DevBot/ObsidianCortex/commit/6c84dfbfb1eff6eab9307b6fb1959a10b0a674c7))
